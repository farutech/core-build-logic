  ...
  const COLS = [
    {
      ...
      links: [
        { to: "/capabilities/product-engineering", label: t.capabilities.items.productEngineering.title },
        { to: "/capabilities/saas-platforms", label: t.capabilities.items.saasPlatforms.title },
        { to: "/capabilities/architecture-consulting", label: t.capabilities.items.architectureConsulting.title },
        { to: "/capabilities/ux-engineering", label: t.capabilities.items.uxEngineering.title },
        { to: "/capabilities/automation-integrations", label: t.capabilities.items.automationIntegrations.title },
      ],
    },
    {
